...
if(!isset($_SESSION['username']) ){
 ...
 if (isset($_POST['submit'])) {
    ...
    $result = mysqli_query($config, "UPDATE tb_member SET nama_lengkap='$nama_lengkap',no_hp='$no_hp',email='$email',alamat_rumah='$alamat_rumah' WHERE id_teruci='$id'");
        header("Location: index.php");
	  }
  $id = $_GET['ID'];

  $result = mysqli_query($config, "SELECT * FROM tb_member WHERE id_teruci='$id'");
